...
public:
   ...
   *
   */
  virtual int enable(u_int8_t driveCurrent, u_int8_t holdCurrent);
   ...
   */
  virtual int home(float velocity, u_int8_t sensitivity, u_int8_t current);
   ...
   */
  virtual int startHoming(float velocity, u_int8_t sensitivity, u_int8_t current);
   ...
   * @return 0 on success,
    ...
    -5 if the joint is not initialized.
   */
  virtual int getPosition(float &pos) = 0;
   ...
   * @return 0 on success,
    ...
    -5 if the joint is not initialized.
   */
  virtual int moveSteps(int32_t steps);
   ...
   * @return 0 on success,
    ...
    -5 if the joint is not initialized.
   */
  virtual int getVelocity(float &vel) = 0;
   ...
   * @return 0 on success,
    ...
    -5 if the joint is not initialized.
   */
  virtual int setVelocity(float vel);
   ...
   * @return 0 on success,
    ...
    -5 if the joint is not initialized.
   */
  virtual int checkOrientation(float angle = 10.0);
   ...
   * @return 0 on success, -1 on communication error,
    -5 if the joint is not initialized.
   */
  virtual int setDriveCurrent(u_int8_t current);
   ...
   * -1 on communication error,
    -5 if the joint is not initialized.
   */
  virtual int setHoldCurrent(u_int8_t current);
   ...
   * @return 0 on success, -1 on communication error,
    -5 if the joint is not initialized.
   */
  virtual int setBrakeMode(u_int8_t mode);
   ...
   * @return 0 on success, -1 on communication error,
    -5 if the joint is not initialized.
   */
  virtual int setMaxAcceleration(float maxAccel);
   ...
   * @return 0 on success, -1 on communication error,
    -5 if the joint is not initialized.
   */
  virtual int setMaxVelocity(float maxVel);
   ...
   * @return 0 on success, -1 on communication error,
    -5 if the joint is not initialized.
   */
  virtual int enableStallguard(u_int8_t sensitivity);
   ...
   * @return flags >= 0 on success,
    -5 if the joint is not initialized.
   */
  virtual u_int8_t getFlags(void);
 ...
 */
  virtual int _home(float velocity, u_int8_t sensitivity, u_int8_t current) = 0;
