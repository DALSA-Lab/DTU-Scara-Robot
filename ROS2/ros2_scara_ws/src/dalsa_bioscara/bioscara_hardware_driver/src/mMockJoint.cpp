...
int MockJoint::getPosition(float &pos)
{
    switch (op_mode)
    {
    case SETRPM:
...
int MockJoint::setPosition(float pos)
{
...
int MockJoint::getVelocity(float &vel)
{
    vel = this->qd;
    return 0;
}

int MockJoint::setVelocity(float vel)
{
...
int MockJoint::checkOrientation(float /*angle*/)
{
    sleep(1);
    return 0;
}

int MockJoint::stop(void)
{
    this->qd = 0.0;
    return 0;
}

int MockJoint::_home(float /*velocity*/, u_int8_t /*sensitivity*/, u_int8_t /*current*/)
{
