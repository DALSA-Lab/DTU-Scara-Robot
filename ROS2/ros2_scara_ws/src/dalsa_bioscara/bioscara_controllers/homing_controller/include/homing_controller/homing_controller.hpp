...
#ifndef HOMING_CONTROLLER__GPIO_COMMAND_CONTROLLER_HPP_
#define HOMING_CONTROLLER__GPIO_COMMAND_CONTROLLER_HPP_
...
#include "homing_controller/homing_controller_parameters.hpp"
...
namespace homing_controller
{
  ...
  using StateInterfaces =
       ...
       */
  class HomingController : public controller_interface::ControllerInterface
  {
  public:
    HomingController();
  ...
  private:
    ...
    controller_interface::return_type update_gpios_commands(const CmdType &gpio_commands);
    template <typename T>
  ...
  protected:
    ...
    std::shared_ptr<homing_controller_parameters::ParamListener> param_listener_{};
    homing_controller_parameters::Params params_;
  };

} // namespace homing_controller

#endif // HOMING_CONTROLLER__GPIO_COMMAND_CONTROLLER_HPP_
