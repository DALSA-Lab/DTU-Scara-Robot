...
namespace bioscara_hardware_interfaces
{
      ...
      const rclcpp_lifecycle::State & /*previous_state*/)
  {
    ...
    bioscara_hardware_drivers::err_type_t rc = _gripper->init();
      ...
      const rclcpp_lifecycle::State & /*previous_state*/)
  {
    ...
    bioscara_hardware_drivers::err_type_t rc = _gripper->deinit();
    if (rc != bioscara_hardware_drivers::err_type_t::OK)
    {
      std::string reason = bioscara_hardware_drivers::error_to_string(rc);
      RCLCPP_FATAL(
      ...
      const rclcpp_lifecycle::State & /*previous_state*/)
  {
    ...
    // enable PWM
    bioscara_hardware_drivers::err_type_t rc = _gripper->enable();
    if (rc != bioscara_hardware_drivers::err_type_t::OK)
    {
      std::string reason = bioscara_hardware_drivers::error_to_string(rc);
      RCLCPP_FATAL(
      ...
      const rclcpp_lifecycle::State & /*previous_state*/)
  {
    ...
    bioscara_hardware_drivers::err_type_t rc = _gripper->disable();
    if (rc != bioscara_hardware_drivers::err_type_t::OK)
    {
      std::string reason = bioscara_hardware_drivers::error_to_string(rc);
      RCLCPP_FATAL(
